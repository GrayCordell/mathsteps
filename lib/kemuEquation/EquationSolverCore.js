...
class EquationSolverCore {
  ...
  _solveInternal(equation) {
    ...
    if (solveFunction == null)
      throw new Error(`no solver for equation: '${scheme}'`)
  ...
  forkEquation(parentEquation, arrayOfChildEquations) {
    ...
    arrayOfChildEquations.forEach((childEquation, _childIdx) => {
...
export default EquationSolverCore
