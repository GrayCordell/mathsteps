...
const defaultCommonPoolOfRules = [
...
module.exports = {
  commonRules:function (node) {
    return simplifyCommon.applyRules(node, defaultCommonPoolOfRules)
  },
  addRule:function (node) {
    return simplifyCommon.applyRules(node, addRule)
  },
  defaultCommonPoolOfRules: defaultCommonPoolOfRules,
}
