import { commonRules, commonRulesPooledTogether } from "./rules/commonRules.js";
...
const POOLED_TOGETHER_POOL_OF_RULES = {
    ...
    convertDecimalToFraction: convertDecimalToFraction,
    ...
    sqrtFromPow: sqrtFromPow,
    // sqrt(n) - calculate if possible.
    sqrtFromConstant: sqrtFromConstant,
    // (a + b)^2 gives a^2 + 2ab + b^2 etc.
    multiplyShortFormulas: multiplyShortFormulas,
    // Numerical result e.g. 1.414 instead of sqrt(2).
    calculateNumericalValue: calculateNumericalValue
};
// Given rulesArray
const rulesArray = [
